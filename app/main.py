...
app = FastAPI(
    ...
    description="A comprehensive laundry service management API with live tracking",
    version="1.0.0"
)
...
async def root():
    return JSONResponse(content={"message": "Laundry App API with Live Tracking is up and running"})

# Health check endpoint
@app.get("/health")
async def health_check():
    return {"status": "healthy", "version": "1.0.0", "features": ["live_tracking", "auto_assignment"]}